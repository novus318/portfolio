          ...
          {id === 2 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                ...
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#10132e2f]"></span>
              </div>
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#10132e6c]"></span>
